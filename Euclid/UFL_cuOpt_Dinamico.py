...
for archivo in archivos:
    ...
    with open("resultados_cuOpt.txt", "a") as f:
        f.write(f"Archivo: {archivo}, Status: {problem.Status.name}, Objective value: {problem.ObjValue}, Solve time: {problem.SolveTime:.2f} seconds\n")
